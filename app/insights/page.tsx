...
export const metadata: Metadata = {
  title: "Insights",
  description:
    "Lead generation and website growth insights from $erocool-Development for founders, small businesses, and technical teams.",
};
    ...
    <div className="site-shell">
      <main className="mx-auto flex w-full max-w-6xl flex-col gap-6 px-6 py-8 md:gap-8 md:px-10 md:py-12">
        <header className="glass-panel rounded-3xl p-7 md:p-10">
          <p className="label-chip inline-flex">$erocool-Development Insights</p>
